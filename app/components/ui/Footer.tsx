  ...
  return (
    <footer
      ...
      <div className="flex flex-col justify-between h-full px-8 py-8 sm:px-10 lg:px-30">
        ...
        {/* Bottom links */}
        <div className="flex items-center justify-between text-[0.6rem] uppercase tracking-[0.2em] text-[#ECEDDD]/40">
          <div className="flex gap-8">
            <Link
              href="/terms"
              className="hover:text-[#ECEDDD] transition-colors duration-200">
              Terms
            </Link>
            <Link
              href="/contact"
